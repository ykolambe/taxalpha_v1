...
import AppLogo from '../images/taxalpha.png';
...
const AdminLogin = () => {
  ...
  const onSubmit = async (e) => {
    ...
    await userLogin(payload).then(async (response) => {
      if (response.data) {
        window.sessionStorage.setItem('user_info', JSON.stringify(response.data));
        history("/dashboard");
      ...
      <section className="bg-gray-50 dark:bg-gray-900">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          <a href="#" className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
            <img className="mr-2 rounded" style={{ height: 90 }} src={AppLogo} alt="logo" />
            <br />
          </a>

          <h2 className="my-2 text-center text-3xl text-white uppercase font-bold mb-5">Tax-Alpha</h2>
